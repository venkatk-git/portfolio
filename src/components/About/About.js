      ...
      <div className={styles.gridWrapper} id="about">
          ...
          <div className={`${styles.techStackWrapper} ${styles.scroller}`}>
            ...
            <div className={styles.scroller__inner}>
              ...
              <Icon
                ...
                className={styles.iconifyIcon}
              />
              <Icon icon="skill-icons:mongodb" className={styles.iconifyIcon} />
              <Icon icon="skill-icons:postman" className={styles.iconifyIcon} />
              <Icon icon="skill-icons:git" className={styles.iconifyIcon} />
              <Icon
                icon="skill-icons:github-light"
                className={styles.iconifyIcon}
              />
              <Icon icon="skill-icons:docker" className={styles.iconifyIcon} />
              <Icon
                icon="skill-icons:npm-light"
        ...
        <div className={`${styles.languages} ${styles.gridItems}`}>
          <div className={styles.languagesWrapper}>
            <Icon icon="skill-icons:c" className={styles.iconifyIcon} />
            <Icon
